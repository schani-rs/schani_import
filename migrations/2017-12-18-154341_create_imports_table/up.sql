...
CREATE TABLE imports (
  ...
  title VARCHAR NULL,
  raw_image_id CHAR(128) NULL,
  sidecar_id CHAR(128) NULL,
  image_id CHAR(128) NULL,
  user_id INTEGER NOT NULL
);

ALTER TABLE imports ALTER COLUMN id
  SET DEFAULT bounded_pseudo_encrypt(nextval('imports_id_seq')::int, 16777215, 1000000);
